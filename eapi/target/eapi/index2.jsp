...
<%@ page session="true" %>
 ...
 <%
	...
	if (payment_data == null && customer_id == null ) {
		 String payment_json = "{\"secret_token\":\"abc123\",\"amount\":\"250.00\",\"currency\":\"THB\",\"collect_addresses\":\"0\",\"status_url\":\"http://api-env.xwauefdnja.us-west-2.elasticbeanstalk.com/Status?uuid=1530b1c4-7e21-464b-8078-c41afd9d24d5\",\"landing_url\":\"http://api-env.xwauefdnja.us-west-2.elasticbeanstalk.com/index.jsp?uuid=1530b1c4-7e21-464b-8078-c41afd9d24d5\"}";
		 session.setAttribute("payment_json",payment_json);
		 payment_data = (String)session.getAttribute("payment_json");
	}else if (customer_id != null){
		 String payment_json = "{\"secret_token\":\"abc123\",\"amount\":\"250.00\",\"currency\":\"THB\",\"customer_id\":\""+customer_id+"\",\"collect_addresses\":\"0\",\"status_url\":\"http://api-env.xwauefdnja.us-west-2.elasticbeanstalk.com/Status?uuid=1530b1c4-7e21-464b-8078-c41afd9d24d5\",\"landing_url\":\"http://api-env.xwauefdnja.us-west-2.elasticbeanstalk.com/index.jsp?uuid=1530b1c4-7e21-464b-8078-c41afd9d24d5\"}";
		 session.setAttribute("payment_json",payment_json);
		 payment_data = (String)session.getAttribute("payment_json");
	}
%>
